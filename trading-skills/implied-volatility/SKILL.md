...
description: Analyze markets using Implied Volatility (IV analysis). Use IV and IV rank to time option strategies. Activate when the user asks to analyze, interpret, or build signals based on Implied Volatility or IV analysis.
