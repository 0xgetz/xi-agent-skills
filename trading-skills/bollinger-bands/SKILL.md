...
description: Analyze markets using Bollinger Bands (volatility bands). Plot a moving average with upper/lower bands at standard-deviation distances to gauge volatility and mean reversion. Activate when the user asks to analyze, interpret, or build signals based on Bollinger Bands or volatility bands.
...
- Analyze or interpret Bollinger Bands on a chart or dataset
- Build buy/sell signals or alerts based on volatility bands
