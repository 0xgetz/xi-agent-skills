...
description: Analyze markets using Linear Regression Channel (regression bands). Fit a regression line with channels to read trend and extremes. Activate when the user asks to analyze, interpret, or build signals based on Linear Regression Channel or regression bands.
