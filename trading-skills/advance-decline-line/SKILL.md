...
description: Analyze markets using Advance Decline Line (market breadth). Measure participation with advancing vs declining issues. Activate when the user asks to analyze, interpret, or build signals based on Advance Decline Line or market breadth.
