...
description: Analyze markets using Accumulation Distribution (A/D line). Track cumulative money flow to confirm or diverge from price. Activate when the user asks to analyze, interpret, or build signals based on Accumulation Distribution or A/D line.
