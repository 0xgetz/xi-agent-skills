...
description: Analyze markets using Open Interest Analysis (futures/options OI). Read OI changes to confirm trend strength or exhaustion. Activate when the user asks to analyze, interpret, or build signals based on Open Interest Analysis or futures/options OI.
