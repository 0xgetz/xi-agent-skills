...
- Native API reference: https://www.alphavantage.co/documentation/
- Tool discovery: Use `safe_call(client, 'alpha_vantage', 'tool_discovery', {})` to list available tools at runtime.
