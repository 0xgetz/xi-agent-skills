...
## Overview
Tracks profitable wallets on BSC and alerts on new positions.
...
```
```bash
docker build -t tg-bsc-smart .
docker run -d -e TELEGRAM_BOT_TOKEN=x -e TELEGRAM_CHAT_ID=y -e SMART_WALLETS=0xWallet1,0xWallet2 tg-bsc-smart
```
