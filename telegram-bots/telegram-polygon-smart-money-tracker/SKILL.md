...
## Overview
Tracks profitable wallets on Polygon and alerts on new positions.
...
```
```bash
docker build -t tg-poly-smart .
docker run -d -e TELEGRAM_BOT_TOKEN=x -e TELEGRAM_CHAT_ID=y -e SMART_WALLETS=0xWallet1,0xWallet2 tg-poly-smart
```
