---
name: telegram-solana-new-token-launch-scanner
description: Build a Telegram bot to detect new token deployments on Solana, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to detect new token deployments on Solana and get alerts in Telegram.
icon: send
color: Teal
---
