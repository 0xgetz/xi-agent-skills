---
name: telegram-solana-smart-money-tracker
description: Build a Telegram bot to follow profitable wallets on Solana, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to follow profitable wallets on Solana and get alerts in Telegram.
icon: send
color: Teal
---

# Telegram Solana Smart Money Tracker
