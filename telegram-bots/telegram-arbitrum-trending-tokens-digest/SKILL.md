---
name: telegram-arbitrum-trending-tokens-digest
description: Build a Telegram bot to post trending-coin digests on Arbitrum, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to post trending-coin digests on Arbitrum and get alerts in Telegram.
icon: send
color: Teal
---
