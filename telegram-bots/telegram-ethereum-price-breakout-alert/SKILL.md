---
name: telegram-ethereum-price-breakout-alert
description: Build a Telegram bot to alert on price breakouts on Ethereum, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to alert on price breakouts on Ethereum and get alerts in Telegram.
icon: send
color: Teal
---
