---
name: telegram-trending-tokens-digest
description: Build a Telegram bot to post a periodic digest of trending coins, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to post a periodic digest of trending coins and get alerts in Telegram.
icon: send
color: Teal
---

# Telegram Trending Tokens Digest

## Overview
A Telegram bot skill that helps post a periodic digest of trending coins. It is a research/monitoring tool that pushes timely alerts to a Telegram chat or channel — it does **not** guarantee profit and does not place trades for you unless you explicitly wire that in.

## When to use this skill
Activate when the user wants to post a periodic digest of trending coins and receive alerts in Telegram.
