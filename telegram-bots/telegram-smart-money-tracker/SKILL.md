---
name: telegram-smart-money-tracker
description: Build a Telegram bot to follow profitable wallets and surface their new positions, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to follow profitable wallets and surface their new positions and get alerts in Telegram.
icon: send
color: Teal
---

# Telegram Smart Money Tracker

## Overview
A Telegram bot skill that helps follow profitable wallets and surface their new positions. It is a research/monitoring tool that pushes timely alerts to a Telegram chat or channel — it does **not** guarantee profit and does not place trades for you unless you explicitly wire that in.

## When to use this skill
Activate when the user wants to follow profitable wallets and surface their new positions and receive alerts in Telegram.
