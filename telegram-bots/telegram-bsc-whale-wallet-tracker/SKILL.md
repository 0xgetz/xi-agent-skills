---
name: telegram-bsc-whale-wallet-tracker
description: Build a Telegram bot to track large wallet moves on BSC, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to track large wallet moves on BSC and get alerts in Telegram.
icon: send
color: Teal
---
