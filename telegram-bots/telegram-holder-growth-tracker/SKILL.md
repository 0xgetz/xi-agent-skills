---
name: telegram-holder-growth-tracker
description: Build a Telegram bot to track rapid growth in holder count, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to track rapid growth in holder count and get alerts in Telegram.
icon: send
color: Teal
---
