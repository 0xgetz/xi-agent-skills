---
name: telegram-new-token-launch-scanner
description: Build a Telegram bot to detect brand-new token deployments and contract creations, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to detect brand-new token deployments and contract creations and get alerts in Telegram.
icon: send
color: Teal
---
