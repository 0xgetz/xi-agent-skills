---
name: telegram-price-breakout-alert
description: Build a Telegram bot to alert on breakouts above key levels, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to alert on breakouts above key levels and get alerts in Telegram.
icon: send
color: Teal
---

# Telegram Price Breakout Alert

## Overview
A Telegram bot skill that helps alert on breakouts above key levels. It is a research/monitoring tool that pushes timely alerts to a Telegram chat or channel — it does **not** guarantee profit and does not place trades for you unless you explicitly wire that in.

## When to use this skill
Activate when the user wants to alert on breakouts above key levels and receive alerts in Telegram.
