---
name: telegram-ethereum-insider-buy-alert
description: Build a Telegram bot to flag insider/team buys on Ethereum, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to flag insider/team buys on Ethereum and get alerts in Telegram.
icon: send
color: Teal
---
