---
name: telegram-ethereum-smart-money-tracker
description: Build a Telegram bot to follow profitable wallets on Ethereum, with on-chain/market data sourcing, risk/honeypot filtering, and Telegram alert delivery. Activate when the user wants to follow profitable wallets on Ethereum and get alerts in Telegram.
icon: send
color: Teal
---
